          ...
          <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-[auto_1fr]">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="mt-2 font-display text-3xl italic md:text-4xl">La leçon particulière</div>
                <div className="text-sm text-muted-foreground">Francis Lai · 1:44</div>
              </div>
